...
app.get('/team_stats', function(req, res){
    var totalGames = 'SELECT * FROM football_games;';
...
app.get('/player_info', function(req,res){
  var playerQuery = 'SELECT id,name FROM football_players;';
...
app.get('/player_info/post', function(req,res){
  ...
  if(player_id != "Select Player"){
    ...
    var totalGames = 'SELECT COUNT(*) FROM football_games LEFT OUTER JOIN football_players ON ARRAY[football_players.id] <@ football_games.players WHERE football_players.id = ' + player_id + ';';
    ...
    .then(data =>{
      res.render('pages/player_info',{
        ...
        player_ID: player_id,
        players: data[0],
        statsOfPlayer: data[1][0],
        totalGames: data[2][0].count
      })
    })
    .catch(error =>{
      // req.flash('error',error);
